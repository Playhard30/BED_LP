    ...
    <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar header-hover-menu left-border">
        <div class="container-fluid navbar-inner">
            <a href="../dashboard/index.html" class="navbar-brand">
                ...
                <!--logo End-->
                <h4 class="logo-title d-block d-xl-none pt-1" data-setting="app_name"></h4>
            </a>
                        ...
                        <div class="p-0 sub-drop dropdown-menu dropdown-menu-end" aria-labelledby="notification-drop">
                            <div class="m-0 shadow-none card">
                                ...
                                <div class="card-footer p-0 text-center">
                                    <div class="d-grid">
                                        <a href="../e-commerce/order-process.html" class="btn btn-primary">View
                                            All</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <li class="nav-item dropdown" id="itemdropdown1">
                        <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button"
                            ...
                            <div class="caption ms-3 d-none d-sm-block">
                                ...
                                <p class="mb-0 caption-sub-title text-center">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            <li>
                                <a class="dropdown-item" href="../login/loginData/logout">Logout</a>
                            </li>
                        </ul>
                    </li>
                </ul>
